...
inline_image: /images/items/consumables/gypsum.png
...
blocks:
  ...
  - type: application_success
    ...
    text: |
     ...
     - Turns the applied {{BANDAGED}} into a {{PLASTER_CAST}}, which will slowly heal arm and leg fractures encased in it.
