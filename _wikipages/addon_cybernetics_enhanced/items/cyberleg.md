...
subcategory: items
permalink: /items/cybernetics_enhanced/cyberleg
# image: /images/svg/anybodypart.svg
inline_image: /images/addon_cybernetics_enhanced/items/cyberleg.png
...
blocks:
  ...
  - type: application_success
    ...
    order: 2
    text: |
     - Applies the Cyberleg on the selected limb and heals any internal damage caused by any previous failed attempts.

  - type: application_failure
    header: "Application Failure:"
    order: 3
    text: |
     - Applies between 15% to 50% {{BLEEDING}} on the Torso. Does not delete the Cyberleg.
---